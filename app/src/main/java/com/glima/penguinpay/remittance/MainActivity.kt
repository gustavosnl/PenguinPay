...
class MainActivity : AppCompatActivity() {
    ...
    private fun observeMoneyTransferSuccess() {
        viewModel.isMoneyTransferred.observe(this) { isSuccess ->
            if (isSuccess) {
                Snackbar.make(binding.root, R.string.money_transfer_succeed, Snackbar.LENGTH_SHORT)
                    .show()
            } else
                Snackbar.make(binding.root, R.string.money_transfer_failed, Snackbar.LENGTH_SHORT)
                    .show()
        }
    }
